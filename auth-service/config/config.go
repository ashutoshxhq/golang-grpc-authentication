...
import (
	...
	"egnite.app/microservices/authentication/config/development"
	"egnite.app/microservices/authentication/config/production"
	"egnite.app/microservices/authentication/config/staging"
